...
def inspect_object_all(
    ...
    # print('----------- FH here ----------- ', par, os.path.join(outdir, "Par{}".format(par)))
    ...
    if tab_R_cont is not None:
        ...
        # print('FH here now ', lamlines_found,ston_found)
...
def inspect_object(
    ...
    while done == 0:
        ...
        # print('FH here ', tab_blue_R, spdata_R)
...
#     if path_to_data == " ":
#         # specnameg1 = ("Par%i_" + str(obj).zfill(5) + ".G115_1D.dat" % (par)) 
#         specnameg1_C = ("A_" + "F277W_" + "GRISMC_" + str(obj) + ".V4_1D.dat") 
#         specnameg1_R = ("A_" + "F277W_" + "GRISMR_" + str(obj) + ".V4_1D.dat") 
#         specnameg2_C = ("A_" + "F356W_" + "GRISMC_" + str(obj) + ".V4_1D.dat") 
#         specnameg2_R = ("A_" + "F356W_" + "GRISMR_" + str(obj) + ".V4_1D.dat") 
#         specnameg3_C = ("A_" + "F444W_" + "GRISMC_" + str(obj) + ".V4_1D.dat") 
#         specnameg3_R = ("A_" + "F444W_" + "GRISMR_" + str(obj) + ".V4_1D.dat") 
#         # specnameg2_C = ("B_" + "F444W_" + "GRISMC_" + str(obj) + ".V4_1D.dat") 
#         # specnameg2_R = ("B_" + "F444W_" + "GRISMR_" + str(obj) + ".V4_1D.dat") 
...
#     else:
#         base_path = path_to_data+ "/Par"+ str(par)+ "/Spectra/"
#         specnameg1_C = (base_path+"A_" + "F277W_" + "GRISMC_" + str(obj) + ".V4_1D.dat") 
#         specnameg1_R = (base_path+"A_" + "F277W_" + "GRISMR_" + str(obj) + ".V4_1D.dat") 
#         specnameg2_C = (base_path+"A_" + "F356W_" + "GRISMC_" + str(obj) + ".V4_1D.dat") 
#         specnameg2_R = (base_path+"A_" + "F356W_" + "GRISMR_" + str(obj) + ".V4_1D.dat") 
#         specnameg3_C = (base_path+"A_" + "F444W_" + "GRISMC_" + str(obj) + ".V4_1D.dat") 
#         specnameg3_R = (base_path+"A_" + "F444W_" + "GRISMR_" + str(obj) + ".V4_1D.dat") 
#         # specnameg2_C = ("B_" + "F444W_" + "GRISMC_" + str(obj) + ".V4_1D.dat") 
#         # specnameg2_R = ("B_" + "F444W_" + "GRISMR_" + str(obj) + ".V4_1D.dat") 
...
#         availgrism += "f277w"
#         tab_blue_R = asciitable.read(specnameg1_R, names=["wave","flux","error","contam","zeroth"])
...
#     if os.path.exists(specnameg1_C):
#         availgrism += "f277w"
#         tab_blue_C = asciitable.read(specnameg1_C, names=["wave","flux","error","contam","zeroth"])
#         tab_blue_C_cont = np.copy(tab_blue_C)
#         tab_blue_C_cont['flux'] = tab_blue_C['flux'] + tab_blue_C['contam']
#     else: tab_blue_C = None; tab_blue_C_cont = None
...
#     if os.path.exists(specnameg2_R):
#         availgrism += "f356w"
#         tab_mid_R = asciitable.read(specnameg2_R, names=["wave","flux","error","contam","zeroth"])
#         tab_mid_R_cont = np.copy(tab_mid_R)
#         tab_mid_R_cont['flux'] = tab_mid_R['flux'] + tab_mid_R['contam']
#     else: tab_mid_R = None; tab_mid_R_cont = None
...
#     if os.path.exists(specnameg2_C):
#         availgrism += "f356w"
#         tab_mid_C = asciitable.read(specnameg2_C, names=["wave","flux","error","contam","zeroth"])
#         tab_mid_C_cont = np.copy(tab_mid_C)
#         tab_mid_C_cont['flux'] = tab_mid_C['flux'] + tab_mid_C['contam']
#     else: tab_mid_C = None; tab_mid_C_cont = None
...
#     if os.path.exists(specnameg3_R):
#         availgrism += "f444w"
#         tab_red_R = asciitable.read(specnameg3_R, names=["wave","flux","error","contam","zeroth"])
#         tab_red_R_cont = np.copy(tab_red_R)
#         tab_red_R_cont['flux'] = tab_red_R['flux'] + tab_red_R['contam']
#     else: tab_red_R = None; tab_red_R_cont = None
...
#     if os.path.exists(specnameg3_C):
#         availgrism += "f444w"
#         tab_red_C = asciitable.read(specnameg3_C, names=["wave","flux","error","contam","zeroth"])
#         tab_red_C_cont = np.copy(tab_red_C)
#         tab_red_C_cont['flux'] = tab_red_C['flux'] + tab_red_C['contam']
#     else: tab_red_C = None; tab_red_C_cont = None
...
#         # print('FH here ', spdata)
#         plot_chooseSpec(spdata_R, spdata_R, spdata_C, config_pars, plottitle, outdir)
#         print_prompt("If you would like to change which spectrum is being fit, the options are: grismR, grismC, grismRcontam, grismCcontam, CombContam, or Comb to go back to the combined at any time. ")
...
# ## OG version - use for CWT line lists
# def mzi_OLD(
#     linelistfile=" ",
#     path_to_data=" ",
#     path_to_code=" ",
...
#     try:
#         secats = glob(path_to_data + "/Par" + str(par) + "/DATA/DIRECT_GRISM/*_A_F444W_i2d.cat")  # FH 12/24/24
#     except:
#         secats = glob(path_to_data + "/Par" + str(par) + "/Products/*_i2d.cat")  # KVN allowing for different path structure (?)
#     secats.sort()
...
#     ##### FH - break down output string to smaller strings:

#     first_str =  ("{:<6d}".format(objid)
#     + "{:>8.5f}".format(fitresults["redshift"])
#     + "{:>8.5f}".format(fitresults["redshift_error"])
#     + "{:>12.6f}".format(ra_obj[0])
#     + "{:>12.6f}".format(dec_obj[0])
...
#     lowlambda_str = ("{:>10.5f}".format(fitresults["la_1216_dz"])
#     + "{:>10.5f}".format(fitresults["c4_1548_dz"])
#     + "{:>10.5f}".format(fitresults["uv_line_dz"])
#     + "{:>10.5f}".format(fitresults["m2_2796_dz"])
#     + "{:>10.5f}".format(fitresults["o2_3727_dz"])
...
#     + "{:>13.2e}".format(fitresults["h2_1640tot_error"])
#     + "{:>13.2e}".format(fitresults["h2_1640tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["h2_1640bro_flux"])
#     + "{:>13.2e}".format(fitresults["h2_1640bro_error"])
#     + "{:>13.2e}".format(fitresults["h2_1640bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["h2_1640nar_flux"])
#     + "{:>13.2e}".format(fitresults["h2_1640nar_error"])
#     + "{:>13.2e}".format(fitresults["h2_1640nar_ew_obs"])
#     + "{:>6d}".format(contamflags["h2_1640"])
#     + "{:>13.2e}".format(fitresults["o3_1660_flux"])
#     + "{:>13.2e}".format(fitresults["o3_1660_error"])
#     + "{:>13.2e}".format(fitresults["o3_1660_ew_obs"])
...
#     midlambda_str = ("{:>13.2e}".format(fitresults["m2_2796_flux"])
#     + "{:>13.2e}".format(fitresults["m2_2796_error"])
#     + "{:>13.2e}".format(fitresults["m2_2796_ew_obs"])
#     + "{:>6d}".format(contamflags["m2_2796"])
#     + "{:>13.2e}".format(fitresults["m2_2803_flux"])
...
#     + "{:>13.2e}".format(fitresults["hg_4342tot_error"])
#     + "{:>13.2e}".format(fitresults["hg_4342tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["hg_4342bro_flux"])
#     + "{:>13.2e}".format(fitresults["hg_4342bro_error"])
#     + "{:>13.2e}".format(fitresults["hg_4342bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["hg_4342nar_flux"])
#     + "{:>13.2e}".format(fitresults["hg_4342nar_error"])
#     + "{:>13.2e}".format(fitresults["hg_4342nar_ew_obs"])
#     + "{:>6d}".format(contamflags["hg_4342"])
#     + "{:>13.2e}".format(fitresults["o3_4363tot_flux"])
#     + "{:>13.2e}".format(fitresults["o3_4363tot_error"])
#     + "{:>13.2e}".format(fitresults["o3_4363tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["o3_4363bro_flux"])
#     + "{:>13.2e}".format(fitresults["o3_4363bro_error"])
#     + "{:>13.2e}".format(fitresults["o3_4363bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["o3_4363nar_flux"])
#     + "{:>13.2e}".format(fitresults["o3_4363nar_error"])
#     + "{:>13.2e}".format(fitresults["o3_4363nar_ew_obs"])
#     + "{:>6d}".format(contamflags["o3_4363"])
#     + "{:>13.2e}".format(fitresults["h2_4686tot_flux"])
#     + "{:>13.2e}".format(fitresults["h2_4686tot_error"])
#     + "{:>13.2e}".format(fitresults["h2_4686tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["h2_4686bro_flux"])
#     + "{:>13.2e}".format(fitresults["h2_4686bro_error"])
#     + "{:>13.2e}".format(fitresults["h2_4686bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["h2_4686nar_flux"])
#     + "{:>13.2e}".format(fitresults["h2_4686nar_error"])
#     + "{:>13.2e}".format(fitresults["h2_4686nar_ew_obs"])
#     + "{:>6d}".format(contamflags["h2_4686"])
#     + "{:>13.2e}".format(fitresults["hb_4863tot_flux"])
#     + "{:>13.2e}".format(fitresults["hb_4863tot_error"])
#     + "{:>13.2e}".format(fitresults["hb_4863tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["hb_4863bro_flux"])
#     + "{:>13.2e}".format(fitresults["hb_4863bro_error"])
#     + "{:>13.2e}".format(fitresults["hb_4863bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["hb_4863nar_flux"])
#     + "{:>13.2e}".format(fitresults["hb_4863nar_error"])
#     + "{:>13.2e}".format(fitresults["hb_4863nar_ew_obs"])
#     + "{:>6d}".format(contamflags["hb_4863"])
#     + "{:>13.2e}".format(fitresults["o3_4959_flux"])
#     + "{:>13.2e}".format(fitresults["o3_4959_error"])
#     + "{:>13.2e}".format(fitresults["o3_4959_ew_obs"])
...
#     highlambda_str = ("{:>13.2e}".format(fitresults["o1_6300_flux"])
#     + "{:>13.2e}".format(fitresults["o1_6300_error"])
#     + "{:>13.2e}".format(fitresults["o1_6300_ew_obs"])
#     + "{:>6d}".format(contamflags["o1_6300"])
#     + "{:>13.2e}".format(fitresults["o1_6363_flux"])
...
#     + "{:>13.2e}".format(fitresults["he10830tot_error"])
#     + "{:>13.2e}".format(fitresults["he10830tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["he10830bro_flux"])
#     + "{:>13.2e}".format(fitresults["he10830bro_error"])
#     + "{:>13.2e}".format(fitresults["he10830bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["he10830nar_flux"])
#     + "{:>13.2e}".format(fitresults["he10830nar_error"])
#     + "{:>13.2e}".format(fitresults["he10830nar_ew_obs"])
#     + "{:>6d}".format(contamflags["he10830"])
#     + "{:>13.2e}".format(fitresults["pg_10941tot_flux"])
#     + "{:>13.2e}".format(fitresults["pg_10941tot_error"])
#     + "{:>13.2e}".format(fitresults["pg_10941tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["pg_10941bro_flux"])
#     + "{:>13.2e}".format(fitresults["pg_10941bro_error"])
#     + "{:>13.2e}".format(fitresults["pg_10941bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["pg_10941nar_flux"])
#     + "{:>13.2e}".format(fitresults["pg_10941nar_error"])
#     + "{:>13.2e}".format(fitresults["pg_10941nar_ew_obs"])
#     + "{:>6d}".format(contamflags["pg_10941"])
#     + "{:>13.2e}".format(fitresults["pb_12822tot_flux"])
#     + "{:>13.2e}".format(fitresults["pb_12822tot_error"])
#     + "{:>13.2e}".format(fitresults["pb_12822tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["pb_12822bro_flux"])
#     + "{:>13.2e}".format(fitresults["pb_12822bro_error"])
#     + "{:>13.2e}".format(fitresults["pb_12822bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["pb_12822nar_flux"])
#     + "{:>13.2e}".format(fitresults["pb_12822nar_error"])
#     + "{:>13.2e}".format(fitresults["pb_12822nar_ew_obs"])
#     + "{:>6d}".format(contamflags["pb_12822"])
#     + "{:>13.2e}".format(fitresults["pa_18756tot_flux"])
#     + "{:>13.2e}".format(fitresults["pa_18756tot_error"])
#     + "{:>13.2e}".format(fitresults["pa_18756tot_ew_obs"])
#     + "{:>13.2e}".format(fitresults["pa_18756bro_flux"])
#     + "{:>13.2e}".format(fitresults["pa_18756bro_error"])
#     + "{:>13.2e}".format(fitresults["pa_18756bro_ew_obs"])
#     + "{:>13.2e}".format(fitresults["pa_18756nar_flux"])
#     + "{:>13.2e}".format(fitresults["pa_18756nar_error"])
#     + "{:>13.2e}".format(fitresults["pa_18756nar_ew_obs"])
#     + "{:>6d}".format(contamflags["pa_18756"]))
    

#     outstr = (
#     first_str + lowlambda_str + midlambda_str + highlambda_str + "\n"
#     )
