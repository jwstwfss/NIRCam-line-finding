...
#M.D.R#        if fieldname[i][0:3] == 'Par' :
#M.D.R#            if os.path.exists(path_wisp +  '/' + fieldname[i] + '_output_alaina-mzr/') :
#M.D.R#                specfile = path_wisp + '/' + fieldname[i] + '_output_alaina-mzr/fitdata/' + fieldname[i] + '_BEAM_' + str(objid[i]) + '_fitspec.dat'
#M.D.R#               # catalog  = path_wisp  + '/' + fieldname[i] + '_output_alaina-mzr/' + fieldname[i] + 'list_catalog_alaina-mzr.dat'

#M.D.R#            elif os.path.exists(path_wisp +'/' + fieldname[i] + '_output_marc-mzr/') :
#M.D.R#                specfile =  path_wisp + '/' + fieldname[i] + '_output_marc-mzr/fitdata/' + fieldname[i] + '_BEAM_' + str(objid[i]) + '_fitspec.dat'
#M.D.R#               # catalog  =  path_wisp + '/' + fieldname[i] + '_output_marc-mzr/' + fieldname[i] + 'list_catalog_marc-mzr.dat'
...
#M.D.R#        else :
#M.D.R#            if os.path.exists(path_3dhst+  '/' + fieldname[i] + '_output_final/'):
#M.D.R#                specfile = path_3dhst + '/' + fieldname[i] + '_output_final/fitdata/' + fieldname[i]+  '_' +  '{:05d}'.format(objid[i]) + '_fitspec.dat'
#M.D.R#                #catalog  = path_3dhst + '/' + fieldname[i] + '_output_alaina-mzr/' + fieldname[i] + '_catalog_alaina-mzr.dat'
#M.D.R#            #elif os.path.exists( path_3dhst + '/' + fieldname[i] + '_output_marc-mzr/'):
#M.D.R#            #    specfile = path_3dhst + '/' + fieldname[i] + '_output_marc-mzr/fitdata/' + fieldname[i] + '_' + '{:05d}'.format(objid[i]) + '_fitspec.dat'
#M.D.R#            #    #catalog  = path_3dhst + '/' + fieldname[i] + '_output_marc-mzr/' + fieldname[i] + '_catalog_marc-mzr.dat'
#M.D.R#            else :
#M.D.R#                specfile = None
#M.D.R#                #catalog = None
#M.D.R#                print 'Could not find fit data directory for ' + fieldname[i]
    ...
    #plt.plot(lam_stack, stack_spec, ls='steps-mid') #M.D.R#
    #plt.show() #M.D.R# Using this shows the spectrum but causes the code to hang indefinitely.
    #plt.savefig(outstack[:-4]+'_test.pdf') #outstack
    #print 'Saving plot... end of stacking.py' #M.D.R#
