...
#FH modified 2/28/25 - make new structure for NIRCam with 1 filter
...
def get_continuum_fit(pars, cont_model, x, first_node_index, nnodes, transition_wave, transition_wave2,  
                      fit_region, la_1216_obs, si7_24833_obs, polycont, lincont):
    ...
    if len(spline_x_values_red) > 0:
        ...
        w = np.where((x >= transition_wave2) & (x < si7_24833_obs  + fit_region))
...
def emissionline_model(pars, x, comps, polycont, lincont):
    ...
    if comps == False:
        ...
        cont_model = get_continuum_fit(pars, cont_model, x, first_node_index, nnodes, transition_wave, transition_wave2, fit_region, 
                      la_1216_obs, si7_24833_obs, polycont, lincont)
    ...
    if comps == True:
        ...
        cont_model_double_gauss = get_continuum_fit(pars, cont_model_double_gauss, x, first_node_index, nnodes, transition_wave, transition_wave2, fit_region, la_1216_obs, si7_24833_obs, polycont, lincont )
...
def fit_obj(input_list,filter='F444W'):
    ...
    w = np.where((lam_spec < la_1216_obs - fit_region) | (lam_spec > si7_24833_obs + fit_region))
    mask_spec[w] = 1.0
    ...
    if out.status > 0:
        ...
        if comps_in == False:
            ...
            "ne3_3869","hd_4102","ne3_3968_he_3970",
            "he1_5875"]
...
def fit_obj_comb(input_list,filter='F444W'):
    ...
    w2 = np.where((lam_spec2 < la_1216_obs - fit_region) | (lam_spec2 > si7_24833_obs + fit_region))
    mask_spec2[w2] = 1.0
...
# #FH modified 2/28/25 - make new structure for NIRCam with 1 filter
# # and to account for redder end of spectrum and 
# def get_continuum_fit(pars, cont_model, x, first_node_index, nnodes, transition_wave, transition_wave2,  
#                       fit_region, la_1216_obs, si7_24833_obs, polycont, lincont):
#     # initialize the continuum and emission line models as lists of zeros are initialized outside this function.    
#     # initialize the x-values (wave) that will be used as nodes for the spline fit.
...
# def fit_obj_PASSAGE(input_list):
#     print('\nRunning fit_obj...\n')
#     lam_spec    = input_list[0]
#     flux_spec   = input_list[1]
#     error_spec  = input_list[2]
